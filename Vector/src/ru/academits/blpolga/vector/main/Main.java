...
public class Main {
    public static void main(String[] args) {
        ...
        vector1.multiplicationVectors(scanner.nextDouble());
        System.out.println("Умножение вектора на скаляр = " + vector1.toString());
        System.out.println("Разворот вектора: " + vector1.reverseVector());
        ...
        System.out.println("Сложение векторов: " + Vector.addVectors(vector1, vector2));
